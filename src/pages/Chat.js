...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    const initializeChat = async () => {
      ...
      const chatSocket = new WebSocket(`ws://114.70.124.15:8000/ws/chat/${roomName}/?userId=${senderId}&username=${senderUsername}`);
  ...
  async function fetchMessages(roomName) {
    try {
      const res = await fetch('http://114.70.124.15:8000/main/getMessagesRecord/', {
        method: 'POST',
